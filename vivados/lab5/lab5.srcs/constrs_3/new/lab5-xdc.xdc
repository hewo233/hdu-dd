...
set_property IOSTANDARD LVCMOS18 [get_ports not_EN]
...
set_property PULLDOWN true [get_ports {C[3]}]
set_property PULLDOWN true [get_ports {C[2]}]
...
set_property PULLDOWN true [get_ports not_EN]
