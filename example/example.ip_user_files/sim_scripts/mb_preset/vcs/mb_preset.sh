...
design_libs=(xpm axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 lib_pkg_v1_0_4 axi_timer_v2_0_33 xil_defaultlib lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_35 interrupt_control_v3_1_5 axi_iic_v2_1_7 dist_mem_gen_v8_0_15 fifo_generator_v13_2_10 lib_fifo_v1_0_19 axi_quad_spi_v3_2_30 microblaze_v11_0_13 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 axi_data_fifo_v2_1_30 axi_crossbar_v2_1_32 axi_intc_v4_1_19 xlconcat_v2_1_6 mdm_v3_2_26 proc_sys_reset_v5_0_15 axi_gpio_v2_0_33)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  vlogan -work dist_mem_gen_v8_0_15 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/09bd/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../bd/mb_preset/ip/mb_preset_lmb_bram_0/sim/mb_preset_lmb_bram_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  vlogan -work xlconcat_v2_1_6 $vlogan_opts +v2k +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mb_preset xil_defaultlib.glbl -o mb_preset_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mb_preset_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mb_preset_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mb_preset_simv.daidir vcs_lib c.obj)
