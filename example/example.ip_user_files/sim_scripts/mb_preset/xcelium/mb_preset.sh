...
#
# Script generated by Vivado on Tue Nov 05 19:04:21 CST 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mb_preset.sh
...
#
# Usage        : mb_preset.sh
#                mb_preset.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mb_preset.sh [-reset_run]
#                mb_preset.sh [-reset_log]
#                mb_preset.sh [-help]
#
...
#                script (type 'mb_preset.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_3 -libname lib_pkg_v1_0_4 -libname axi_timer_v2_0_33 -libname xil_defaultlib -libname lib_srl_fifo_v1_0_4 -libname axi_uartlite_v2_0_35 -libname interrupt_control_v3_1_5 -libname axi_iic_v2_1_7 -libname dist_mem_gen_v8_0_15 -libname fifo_generator_v13_2_10 -libname lib_fifo_v1_0_19 -libname axi_quad_spi_v3_2_30 -libname microblaze_v11_0_13 -libname lmb_v10_v3_0_14 -libname lmb_bram_if_cntlr_v4_0_24 -libname blk_mem_gen_v8_4_8 -libname generic_baseblocks_v2_1_2 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname axi_data_fifo_v2_1_30 -libname axi_crossbar_v2_1_32 -libname axi_intc_v4_1_19 -libname xlconcat_v2_1_6 -libname mdm_v3_2_26 -libname proc_sys_reset_v5_0_15 -libname axi_gpio_v2_0_33 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 lib_pkg_v1_0_4 axi_timer_v2_0_33 xil_defaultlib lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_35 interrupt_control_v3_1_5 axi_iic_v2_1_7 dist_mem_gen_v8_0_15 fifo_generator_v13_2_10 lib_fifo_v1_0_19 axi_quad_spi_v3_2_30 microblaze_v11_0_13 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 axi_data_fifo_v2_1_30 axi_crossbar_v2_1_32 axi_intc_v4_1_19 xlconcat_v2_1_6 mdm_v3_2_26 proc_sys_reset_v5_0_15 axi_gpio_v2_0_33)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mb_preset.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mb_preset.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  xmvlog -work dist_mem_gen_v8_0_15 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/09bd/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../bd/mb_preset/ip/mb_preset_lmb_bram_0/sim/mb_preset_lmb_bram_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  "../../../../example.gen/sources_1/bd/mb_preset/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_32 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
  ...
  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/ec67/hdl" +incdir+"../../../../example.gen/sources_1/bd/mb_preset/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mb_preset xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mb_preset -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mb_preset_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mb_preset.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mb_preset.sh [-help]\n\
Usage: mb_preset.sh [-step]\n\
Usage: mb_preset.sh [-lib_map_path]\n\
Usage: mb_preset.sh [-reset_run]\n\
Usage: mb_preset.sh [-reset_log]\n\
Usage: mb_preset.sh [-keep_index]\n\
Usage: mb_preset.sh [-noclean_files]\n\n\
